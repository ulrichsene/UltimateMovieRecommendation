...
data['Plot Keywords'] = data['Plot Keywords'].apply(list_to_string)
data['Top 5 Casts'] = data['Top 5 Casts'].apply(list_to_string)

data["combined_features"] = (
    "Keywords: " + data["Plot Keywords"] + " " +
    "Actors: " + data["Top 5 Casts"] + " " +
    "Director: " + data["Director"] + " " +
    "Genres: " + data["Generes"] 
)

df_filtered = data[['Plot Keywords', 'Director', 'Top 5 Casts', 'Generes']]
# df_filtered.to_csv('movies_non_plot_features.csv', index=False)

simple_movie = data["Movie title"]
simple_movie.to_json("movie_list.json")
...
print("Fixed JSON saved as movies.json")
